...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6281331954019:+62 857-0461-7188\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '#'
limitawal = 30
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6281331954019@s.whatsapp.net","6285704617188@s.whatsapp.net"] 
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan.subscribe','white'),color('YOU','red'),color('TUBE','white'),color('fian gaming','yellow'))
})
